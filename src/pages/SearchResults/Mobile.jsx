...
              >
                {/* START: Card Content - FINAL UI with normal colors */}
                
...
                           {/* Bus Type in Light Blue Pill - TEXT COLOR CHANGED TO BLACK/DARK GRAY */}
                            <span 
                                className="inline-flex items-center text-xs font-normal px-2 py-0.5 rounded-full"
                                style={{ 
                                  color: '#1F2937', // Changed from '#1D4ED8' to a dark gray/black
                                  backgroundColor: '#DBEAFE', // Light Blue Color Pill (Blue 100) - REMAINS
                                }}
                            >
                                {bus.busType}
                            </span>
                            {/* Seat Count Down Pill - TEXT COLOR CHANGED TO BLACK/DARK GRAY */}
                            {typeof availableSeats === "number" && (
                              <span
                                  className="inline-flex items-center text-xs font-normal px-2 py-0.5 rounded-full"
                                  style={{ 
                                    color: '#1F2937', // Changed from PALETTE.primaryRed to a dark gray/black
                                    backgroundColor: '#FEE2E2', // Light red color pill (Red 100) - REMAINS
                                  }}
                              >
...
                    
                    {/* Booking Deadline Timer (LEFT SIDE) - TEXT COLOR CHANGED TO BLACK/DARK GRAY */}
                     <div className="flex-1 min-w-0">
                         {timerProps && (
                             <span
                                 className="px-2 py-0.5 rounded-full text-xs font-medium inline-block relative"
                                 style={{ color: '#1F2937', backgroundColor: '#FFF7ED' }} // Color changed, background color explicitly set back to the base orange shade for consistency
                             >
