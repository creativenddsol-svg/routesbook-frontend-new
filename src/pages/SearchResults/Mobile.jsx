...
                           {/* Bus Type in Light Blue Pill -> FONT COLOR MODIFIED */}
                            <span 
                                className="inline-flex items-center text-xs px-2 py-0.5 rounded-full font-normal" // Added font-normal
                                style={{ 
                                  color: '#1F2937', // Black Text (Gray 800)
                                  backgroundColor: '#DBEAFE', // Reverted to Light Blue Color Pill (Blue 100)
                                }}
                            >
                                {bus.busType}
                            </span>
                            {/* Seat Count Down Pill -> FONT COLOR MODIFIED */}
                            {typeof availableSeats === "number" && (
                              <span
                                  className="inline-flex items-center text-xs px-2 py-0.5 rounded-full font-normal" // Added font-normal
                                  style={{ 
                                    color: '#1F2937', // Black Text (Gray 800)
                                    backgroundColor: '#FEE2E2', // Reverted to Light red color pill (Red 100)
                                  }}
                              >
...
                    
                    {/* Booking Deadline Timer (LEFT SIDE) -> FONT COLOR AND WEIGHT MODIFIED */}
                     <div className="flex-1 min-w-0">
                         {timerProps && (
                             <span
                                 className="px-2 py-0.5 rounded-full text-xs inline-block" // Removed font-medium/semibold
                                 style={{ backgroundColor: "#FFF7ED", color: "#1F2937" }} // Reverted BG, Changed Text to Black
                             >
...
                                Rs.
                            </span>
                            {/* Price remains text-black font-semibold */}
                            <span
