...
const SearchResults = ({ showNavbar, headerHeight, isNavbarAnimating }) => {
  ...
  /* --- 🆕 Mobile header pill & dropdown search state --- */
              ...
              {cells.map((d, idx) => {
                ...
                return (
                  <button
                    ...
                    className={classes}
                    style={{
                      border: isToday && !selectedDay ? "1px solid #D84E55" : undefined,
                    }}
                  >
                    {d.getDate()}
                  </button>
          ...
          {visibleBuses.map((bus) => {
            ...
            if (searchDateParam && bus.departureTime) {
              ...
              const [depHour, depMinute] = bus.departureTime
                .split(":")
                .map(Number);
              const [year, month, day] = searchDateParam
                .split("-")
                .map(Number);
  ...
  return (
    <div className="flex flex-col min-h-screen font-sans">
      ...
      {/* Global mobile full-page & sheets */}
      <MobileBottomSheet />
      <MobileSearchSheet />
      <MobileCityPicker
