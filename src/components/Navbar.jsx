...
const Navbar = () => {
  ...
  if (loading) return null; // ✅ Avoid flickering due to uninitialized user

  return (
    <>
      <nav
        key={user?._id || "guest"} // ✅ force re-render on login/logout
      ...
      >
        ...
        />
        <div className="relative w-full max-w-xs h-full bg-white ml-auto flex flex-col">
