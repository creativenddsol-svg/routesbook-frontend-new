  ...
  theme: {
    extend: {
      ...
      fontSize: {
        ...
        sm: ["0.8125rem", { lineHeight: "1.25rem" }], // 13px - slightly smaller than default sm (14px)
        base: ["0.875rem", { lineHeight: "1.375rem" }], // 14px - slightly smaller than default base (16px)
        md: ["1rem", { lineHeight: "1.5rem" }], // 16px (equivalent to default base, now named 'md')
        lg: ["1.125rem", { lineHeight: "1.75rem" }], // 18px
        xl: ["1.25rem", { lineHeight: "1.875rem" }], // 20px
        "2xl": ["1.5rem", { lineHeight: "2rem" }], // 24px
        "3xl": ["1.875rem", { lineHeight: "2.25rem" }], // 30px
        "4xl": ["2.25rem", { lineHeight: "2.5rem" }], // 36px
        "5xl": ["3rem", { lineHeight: "1" }], // 48px - added for potentially larger hero headings
      },
      lineHeight: {
        none: "1",
        ...
        relaxed: "1.625", // For longer paragraphs, if needed
      },
    },
  },
  plugins: [],
